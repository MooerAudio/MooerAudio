...
//    }
    ...
    public static SnowflakeSequence idWorker;
    
    @Autowired
    public void init(UtilProp utilProp) {
    	SnowflakeSequence.utilProp = utilProp;
    }
    
    public static long gen() {
    	if(SnowflakeSequence.idWorker==null) {
    		SnowflakeSequence.idWorker = new SnowflakeSequence(utilProp.getWorkerId(),utilProp.getDatacenterId());
    	}
    	return SnowflakeSequence.idWorker.nextId();
    }
}
